...
class DT_Dummy {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dt-dummy-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dt-dummy-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the Dashboard.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-dt-dummy-admin.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/dt-dummy-admin-functions.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-dt-dummy-public.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dt-dummy-content.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new DT_Dummy_Admin( $this->get_plugin_name(), $this->get_version() );
